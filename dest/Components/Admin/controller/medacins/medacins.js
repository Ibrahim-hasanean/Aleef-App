...
const addMedacin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!pet)
        return res.status(400).json({ status: 400, msg: "pet not found" });
    let newMedacin = yield Medacine_1.default.create({ name, duration, pet: petId, repetition, notes });
...
const updateMedacin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!pet)
        return res.status(400).json({ status: 400, msg: "pet not found" });
    let newVaccinations = yield Medacine_1.default.findByIdAndUpdate(medacinId, { name, duration, repetition, notes });
